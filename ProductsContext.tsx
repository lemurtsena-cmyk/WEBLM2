...
const defaultProducts: Product[] = [
  {
    ...
    features: ['Plateau mélamine 25mm', 'Structure acier noir mat', 'Passe-câbles intégré', 'Tiroirs soft-close'],
  ...
  },
  {
    ...
    features: ['Étagères réglables', 'Structure tubulaire', 'Finition bois naturel', 'Montage facile'],
    price: 'À partir de 280 000 Ar',
  },
  {
    id: 3,
    name: 'Table à Manger',
    category: 'Salle à manger',
    description: 'Table à manger contemporaine avec plateau en mélamine et pieds en métal. Idéale pour vos repas en famille.',
    image: '/images/product-table.jpg',
    features: ['Plateau anti-rayures', 'Pieds en acier renforcé', '6 à 8 places', 'Facile à nettoyer'],
    price: 'À partir de 520 000 Ar',
  },
  {
    id: 4,
    name: 'Dressing Sur Mesure',
    category: 'Chambre',
    description: 'Dressing personnalisé en mélamine avec structure métallique. Optimisez votre espace de rangement.',
